...
/**
 * It is the dashboard animation class provides dashboard type animation effect to the java panel.
    ...
    void rotationFinished() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                DashboardAnimation.access$1(DashboardAnimation.this, null);
            }
        });
    }
...
//        SpecialOp(final DashboardAnimation this$0) {
//            this(this$0, 0.0);
//        }
//        SpecialOp(DashboardAnimation c,final double ang){
//            this.ds=c;
//            this.angle=ang;
//        }
    ...
    final class SpecialPanel extends JPanel
    {
        ...
        SpecialPanel(final DashboardAnimation owner, final BufferedImage firstImage, final BufferedImage secondImage) {
        ...
        SpecialPanel(final DashboardAnimation owner, final Component component1, final Component component2) {
            this.stroke2 = new BasicStroke(2.0f);
            this.stroke1 = new BasicStroke(1.0f);
            this.angle = 0.0;
            this.beginAngle = 0.0;
            ...
            final Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    while ((SpecialPanel.this.angle < SpecialPanel.this.endAngle - SpecialPanel.this.deltaAngle / 2.0 || SpecialPanel.this.deltaAngle <= 0.0) && (SpecialPanel.this.angle > SpecialPanel.this.endAngle - SpecialPanel.this.deltaAngle / 2.0 || SpecialPanel.this.deltaAngle >= 0.0)) {
                        ...
                        if ((int)SpecialPanel.this.angle % 90 == 0) {
                            final SpecialPanel this$1 = SpecialPanel.this;
                            this$1.angle += SpecialPanel.this.deltaAngle;
                        }
                        try {
                    ...
                    if (Math.abs(SpecialPanel.this.angle - 360.0) < absDeltaAngle / 2.0) {
                        SpecialPanel.this.angle = 0.0;
                    }
                    if (Math.abs(SpecialPanel.this.angle - 180.0) < absDeltaAngle / 2.0) {
                        SpecialPanel.this.angle = 180.0;
                    }
                    SpecialPanel.this.repaint();
...
//                    }
        ...
        public synchronized void paint(final Graphics g) {
            ...
            if (currImage != null) {
                final double cosa = Math.cos(3.141592653589793 * needAngle / 180.0);
                ...
                g2d.drawImage(currImage, this.op, -(int)Math.round(ww * (1.0 - cosa) / 2.0), 0);
