...
/**
 * It is the Fade animation class provides Fade in and out animation effect to the java panel.
...
public class FadeAnimation implements Animation
{
    ...
    void rotationFinished() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                FadeAnimation.access$1(FadeAnimation.this, null);
            }
        });
    }
    ...
    static /* synthetic */ void access$1(final FadeAnimation $0, final AnimationListener $1) {
        $0.listener = $1;
    }
    ...
    class SpecialPanel extends JPanel
    {
        ...
        SpecialPanel(final FadeAnimation owner, final BufferedImage firstImage, final BufferedImage secondImage) {
            this.angle = 0.0f;
        ...
        SpecialPanel(final FadeAnimation owner, final Component component1, final Component component2) {
            this.angle = 0.0f;
            this.beginAngle = 0.0f;
            this.endAngle = 360.0f;
            this.deltaAngle = 0.5f;
...
//                    }
        ...
        public synchronized void paint(final Graphics g) {
            ...
            g2d.setComposite(AlphaComposite.getInstance(3, 1.0f - alpha));
