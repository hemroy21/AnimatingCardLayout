...
/**
 * It is the slide animation class provides sliding animation effect to the java panel.
...
public class SlideAnimation implements Animation
{
    ...
    public Component animate(final Component toHide, final Component toShow, final AnimationListener listener) {
        ...
        this.animationPanel.beginAngle = (float)(this.direction ? 0 : 180);
        this.animationPanel.endAngle = (float)(this.direction ? 180 : 0);
    ...
    void rotationFinished() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                SlideAnimation.this.animationPanel = null;
                SlideAnimation.this.listener.animationFinished();
                SlideAnimation.access$1(SlideAnimation.this, null);
            }
        });
    }
    ...
    static /* synthetic */ void access$1(final SlideAnimation $0, final AnimationListener $1) {
        $0.listener = $1;
    }
    ...
    class SpecialPanel extends JPanel
    {
        ...
        SpecialPanel(final SlideAnimation owner, final BufferedImage firstImage, final BufferedImage secondImage) {
            this.angle = 0.0f;
        ...
        SpecialPanel(final SlideAnimation owner, final Component component1, final Component component2) {
            this.angle = 0.0f;
            this.beginAngle = 0.0f;
            this.endAngle = 360.0f;
            this.deltaAngle = 0.5f;
...
//                    }
        ...
        public synchronized void paint(final Graphics g) {
            ...
            int offset = (int)(w * this.angle / 180.0f);
            if (offset < 0) {
                offset = 0;
            }
            if (offset > w) {
            ...
            g2d.drawImage(this.secondImage, null, w - offset, 0);
