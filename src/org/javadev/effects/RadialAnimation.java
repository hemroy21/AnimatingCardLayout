...
/**
 * It is the Radial animation class provides radial opening animation effect to the java panel.
...
public class RadialAnimation implements Animation
{
    ...
    void rotationFinished() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                RadialAnimation.this.animationPanel = null;
                RadialAnimation.this.listener.animationFinished();
                RadialAnimation.access$1(RadialAnimation.this, null);
            }
        });
    }
    
    public RadialAnimation() {
    ...
    static /* synthetic */ void access$1(final RadialAnimation $0, final AnimationListener $1) {
        $0.listener = $1;
    }
    ...
    class SpecialPanel extends JPanel
    {
        ...
        SpecialPanel(final RadialAnimation owner, final BufferedImage firstImage, final BufferedImage secondImage) {
            this.angle = 0.0f;
        ...
        SpecialPanel(final RadialAnimation owner, final Component component1, final Component component2) {
            this.angle = 0.0f;
            this.beginAngle = 0.0f;
            this.endAngle = 360.0f;
            this.deltaAngle = 0.5f;
...
//                    }
        ...
        public synchronized void paint(final Graphics g) {
            ...
            final float r = (float)Math.sqrt(ww * ww + hh * hh) / 2.0f;
            final Arc2D.Float arc = new Arc2D.Float(ww / 2 - r, hh / 2 - r, 2.0f * r, 2.0f * r, 0.0f, needAngle, 2);
            g2d.setClip(arc);
